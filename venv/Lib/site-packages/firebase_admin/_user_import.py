...
class UserProvider:
    ...
    Args:
        firebase_uid: User's unique ID assigned by the identity provider.
    ...
    def __init__(self, firebase_uid, provider_id, email=None, display_name=None, photo_url=None):
    ...
    @firebase_uid.setter
    def firebase_uid(self, firebase_uid):
        self._uid = _auth_utils.validate_uid(firebase_uid, required=True)
...
class ImportUserRecord:
    ...
    Must specify the ``firebase_uid`` field at a minimum. A sequence of ``ImportUserRecord`` objects can be
    ...
    Args:
        firebase_uid: User's unique ID. Must be a non-empty string not longer than 128 characters.
        email: User's email address (optional).
    ...
    def __init__(self, firebase_uid, email=None, email_verified=None, display_name=None, phone_number=None,
