...
class TokenGenerator:
    ...
    def create_custom_token(self, firebase_uid, developer_claims=None, tenant_id=None):
        ...
        if not firebase_uid or not isinstance(firebase_uid, str) or len(firebase_uid) > 128:
            raise ValueError('firebase_uid must be a string between 1 and 128 characters.')
    ...
    def verify(self, token, request, clock_skew_seconds=0):
        ...
        if audience == FIREBASE_AUDIENCE:
            ...
            if header.get('alg') == 'HS256' and payload.get(
                    'v') == 0 and 'firebase_uid' in payload.get('d', {}):
                error_message = (
        ...
        try:
            ...
            verified_claims['firebase_uid'] = verified_claims['sub']
