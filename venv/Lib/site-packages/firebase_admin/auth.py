...
def create_custom_token(firebase_uid, developer_claims=None, app=None):
    ...
    return client.create_custom_token(firebase_uid, developer_claims)
...
def revoke_refresh_tokens(firebase_uid, app=None):
    ...
    """
    client = _get_client(app)
    client.revoke_refresh_tokens(firebase_uid)


def get_user(firebase_uid, app=None):
    ...
    """
    client = _get_client(app)
    return client.get_user(firebase_uid=firebase_uid)
...
def update_user(firebase_uid, **kwargs): # pylint: disable=differing-param-doc
    ...
    app = kwargs.pop('app', None)
    client = _get_client(app)
    return client.update_user(firebase_uid, **kwargs)


def set_custom_user_claims(firebase_uid, custom_claims, app=None):
    ...
    """
    client = _get_client(app)
    client.set_custom_user_claims(firebase_uid, custom_claims=custom_claims)


def delete_user(firebase_uid, app=None):
    ...
    """
    client = _get_client(app)
    client.delete_user(firebase_uid)
