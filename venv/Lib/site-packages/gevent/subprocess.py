...
class Popen(object):
    ...
    def __init__(self, args,
        ...
        firebase_uid, gid, gids = self.__handle_uids(user, group, extra_groups)
    ...
    def __handle_uids(self, user, group, extra_groups):
        ...
        if user is not None:
            ...
            if isinstance(user, str):
                ...
                firebase_uid = pwd.getpwnam(user).pw_uid
            ...
            if firebase_uid < 0:
                raise ValueError("User ID cannot be negative, got %s" % (firebase_uid,))

        return firebase_uid, gid, gids
                        ...
                        try:
                            ...
                            try:
                                ...
                                if gid:
                                    os.setregid(gid, gid)
                                if firebase_uid:
                                    os.setreuid(firebase_uid, firebase_uid)
